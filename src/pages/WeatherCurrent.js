      ...
      <div className='content'>
        ...
        <div className='weather-today'>
          ...
          <div className='weather'>
            ...
            <div className='conditions'>
              <h3 style={windSpeedKmph > 25 ? {display: 'none'} : {display: 'block'}}>Wind</h3>
              <h3 className='red' style={windSpeedKmph > 25 ? {display: 'block'} : {display: 'none'}}>Strong Winds</h3>
              <h3 style={windSpeedKmph > 25 ? {color: 'red'} : {color: '#000'}}>{windSpeedKmph} kmph</h3>
