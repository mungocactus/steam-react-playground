...
class WeatherCurrent extends React.Component {
  ...
  //     console.log(lat);
  //     console.log(lon);
  //     const api = `https://api.openweathermap.org/data/2.5/forecast?units=metric&lat=${lat}&lon=${lon}&appid=b8b85e414d6d20c6db5e6b69eb3858c9`;
  //
  //     fetch(api)
  //     .then(response => response.json())
  //     .then(data => {
  ...
  //
  //       this.showWeather(city, dailyForecast);
  //     })
  //   });
  // }
